...
interface WeatherApi {
    ...
    suspend fun getForecastWeather(@Query("q") city: String, @Query("lang") lang: String): Forecast

    @GET("v1/search.json?key=770c2027b7ee4720873103832220907")
    suspend fun getSearchList(@Query("q") city: String, @Query("lang") lang: String): SearchCity
}